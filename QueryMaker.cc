...
void WriteOutNode::run(vector<RelationalOp *> *operators) {
    ...
    writeOutOperator->WaitUntilDone();
...
void GroupByNode::run(vector<RelationalOp *> *operators) {
    ...
    groupByOperation->WaitUntilDone();
